  ...
  return (
    <div ref={wrapperRef} className="relative z-20">
      <button
        ...
        className="flex items-center space-x-2 bg-slate-700 hover:bg-slate-600 text-slate-200 px-3 py-1.5 rounded-full text-xs font-medium focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2 focus:ring-offset-slate-900 transition-colors"
        aria-haspopup="true"
      ...
      {isOpen && (
        <div
          className="absolute top-full right-0 mt-2 w-48 bg-slate-700/95 backdrop-blur-sm rounded-md shadow-xl py-1 z-30 ring-1 ring-black ring-opacity-5"
          role="menu"
        ...
        >
          {languages.map((lang) => (
            <button
              ...
              className="flex items-center space-x-3 w-full text-left px-4 py-2 text-sm text-slate-200 hover:bg-sky-600 hover:text-white transition-colors"
              role="menuitem"
            ...
            >
              ...
              {currentLanguage === lang.code && (
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-sky-400 ml-auto" viewBox="0 0 20 20" fill="currentColor">
