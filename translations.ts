...
const translationsData: AllTranslations = {
  'pt-BR': {
    ...
    ui: {
      ...
      "Encounter Notes": "Notas de Encontro",
      "Height": "Altura",
      "Weight": "Peso",
      "Hidden": "Oculta",
      "Close modal": "Fechar modal",
      "Loading encounter notes...": "Carregando notas de encontro...",
      "Could not retrieve encounter notes.": "Não foi possível obter as notas de encontro.",
      ...
      // GymLeaderCard
      "Counter strategy unavailable.": "Estratégia de contra-ataque indisponível.",
      "Counter strategy data is invalid.": "Dados da estratégia de contra-ataque inválidos.",
      "Analyzing strategy...": "Analisando estratégia...",
      "Counter Strategy:": "Estratégia de Contra-ataque:",
      "Recommended Types:": "Tipos Recomendados:",
      "Tactical Tip:": "Dica Tática:",
      ...
      "Enrichment by Gemini API.": "Enriquecimento pela API Gemini.",
      ...
      "Language": "Idioma", // Kept if used elsewhere, but new switcher has its own
      "Change language": "Mudar idioma", // For the globe button
      "Switch to English": "Mudar para Inglês", // Old button text, might remove if not used
      "Switch to Portuguese (Brazil)": "Mudar para Português (Brasil)", // Old button text
  ...
  'en': {
    ...
    ui: {
      ...
      "Loading encounter notes...": "Loading encounter notes...",
      "Could not retrieve encounter notes.": "Could not retrieve encounter notes.",
      ...
      // GymLeaderCard
      "Counter strategy unavailable.": "Counter strategy unavailable.",
      "Counter strategy data is invalid.": "Counter strategy data is invalid.",
      "Analyzing strategy...": "Analyzing strategy...",
      "Counter Strategy:": "Counter Strategy:",
      "Recommended Types:": "Recommended Types:",
      "Tactical Tip:": "Tactical Tip:",
      ...
      "Enrichment by Gemini API.": "Enrichment by Gemini API.",
